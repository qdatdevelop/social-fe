export const menu = [
    {
        name: "Campus",
        icon: "campus",
        description: "A unique, exclusive space for college students on Zuino.",
    },
    {
        name: "Events",
        icon: "events",
    ...
    },
    {
        name: "Pages",
        icon: "pages",
        description: "Discover and connect with businesses on Zuino.",
    },
    {
        name: "Gaming Video",
        icon: "gaming",
    ...
    },
    {
        ...
        icon: "recent",
        description: "See all the ads you interacted with on Zuino.",
    },
    {
        name: "Memories",
        icon: "memories",
        description: "Browse your old photos, videos and posts on Zuino.",
    },
    {
        name: "Saved",
        icon: "saved",
