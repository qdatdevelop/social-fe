    ...
    return (
        <div className="reset">
            <div className="reset_header">
                <img src="./icons/logo 3.png" alt="" height={40} />
                {user ? (
            ...
            <div className="reset_wrap">
                ...
                {visible === 2 && (
                    <CodeVerification user={user} code={code} setCode={setCode} error={error} setError={setError} setLoading={setLoading} setVisible={setVisible} userInfos={userInfos} />
                )}
                {visible === 3 && (
                    <ChangePassword
                        password={password}
