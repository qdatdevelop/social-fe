...
export default function Chat_screen_Large({ setShowChat, showChat, socket, onlineUsers, getListMess, stt, closeChatWindow, detail, setDetail, setVisiblePhotoDetail }) {
    ...
    const handleIcon = async (e) => {
        const messages = await sendMessage(showChat?._id, showChat?.icon, "", user.token);
        setMessages(messages.newMessages);
        socket.emit("sendMessage", {
            senderId: user.id,
            receiverId: showChat._id,
                        ...
                        <>
                            {messages &&
                                messages
                                    ...
                                    .map((message, i) => <Mess_Screen message={message} user={user} key={i} showChat={showChat} socket={socket} setVisiblePhotoDetail={setVisiblePhotoDetail} />)}
                        </>
                    ) : (
                        <>
