...
export default function SearchMessMenu({ color, setShowSearchMenu, token, listMess, setOpenChatWindowMess, onlineUsers }) {
    ...
    return (
        <div className="header_left search_area scrollbar" ref={menu} style={{ width: "340px" }}>
