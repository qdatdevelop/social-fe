...
export default function Room_Mess_screen_Large({ showChatRoom, socket, setShowChatRoom, onlineUsers, getListMess, stt, closeChatWindow, detail, setDetail, roomid, idroom, setVisiblePhotoDetail }) {
    let chatWindowStyle;
    ...
    return (
        <>
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <div className="contact" style={{ display: "flow", flexDirection: "column" }}>
                            <span style={{ fontSize: "17px" }}>{showChatRoom?.room_name}</span>
                            <p
                                style={{
                                    fontSize: "13px",
                ...
                <div className="messages_screen scrollbar" style={detail ? { width: "963px" } : { width: "1324px" }} ref={chatContainerRef}>
                    <div
                        style={{
                            position: "relative",
                            display: "flex",
                        ...
                        <>
                            ...
                            {messages &&
                                messages
                                    ...
                                    .map((message, i) => (
                                        <MessRoom_Screen message={message} user={user} key={i} showChatRoom={showChatRoom} socket={socket} setVisiblePhotoDetail={setVisiblePhotoDetail} />
                                    ))}
                        </>
                    ) : (
                        <>
