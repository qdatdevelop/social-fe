            ...
            <div className="pagegroup_grid">
                <div className="pagegroup_left">
                    ...
                    <div className="profile_card">
                        <div className="private_discussion">
                            <img src="https://www.Zuino.com/images/comet/empty_states_icons/permissions/permissions_gray_wash.svg" alt="" width="112px" height="112px" />
                ...
                <div className="pagegroupe_right" ref={rightSide}>
                    {loading ? (
                        ...
                        <>
                            <About_group idGroup={idGroup} dataPageGroup={dataPageGroup} detailss={[]} visitor={member} setOthername={setOthername} />
                        </>
                    )}
                </div>
            </div>
