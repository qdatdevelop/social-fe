    ...
    return (
        <div className="header_left search_area scrollbar" ref={menu}>
                    ...
                    searchHistory
                        ...
                        .map((user) => (
                            <div className="search_user_item hover1" key={user._id}>
                                <Link className="flex " to={`/profile/${user.user._id}`} onClick={() => addToSearchHistoryHandler(user.user._id)}>
            ...
            <div className="search_results scrollbar">
                {results &&
                    results.map((user) => (
                        <Link to={`/profile/${user._id}`} className="search_user_item hover1" onClick={() => addToSearchHistoryHandler(user._id)} key={user._id}>
