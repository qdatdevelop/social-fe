...
export default function SubmitSpam({ setVisible, type, submitReportToAdmin, loading }) {
    return (
        <>
            <div className="mmenu_main">
                <div className="mmenu_col">
                    <div style={{ fontSize: "18px", fontWeight: "700" }}>Spam</div>
                    <div style={{ fontSize: "15px", color: "#65676b" }}>We don’t allow things like:</div>
                    <div
                        style={{
                            fontSize: "15px",
                            color: "#65676b",
                        ...
                        <div style={{ display: "flex", marginTop: "10px" }}>
                            {" "}
                            <li /> Directing people away from Zuino through the misleading use of links){" "}
                        </div>
                    </div>
                    <button
