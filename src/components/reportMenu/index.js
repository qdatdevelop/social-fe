...
export default function ReportMenu({ setReport, report }) {
    ...
    const [{ loadingReportToGroup, errorReportToGroup, reportToGroup }, dispatchReportToGroup] = useReducer(submitReportToGroupReducer, {
    ...
    return (
        <div
            ...
            <div className="mmenu_report">
                    ...
                    <div>
                        <div className="mmenu_main">
                            <div className="mmenu_col">
                                <div style={{ fontSize: "18px", fontWeight: "700" }}>Please select a problem</div>
                                <div style={{ fontSize: "15px", color: "#65676b" }}>If someone is in immediate danger, get help before reporting to Zuino. Don't wait.</div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>Nudity</span>
                        ...
                        <div
                            ...
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>Violence</span>
                            <div className="rArrow">
                                <i className="right_icon"></i>
                            </div>
                        </div>
                        <div
                            ...
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>False infomation</span>
                            <div className="rArrow">
                                <i className="right_icon"></i>
                            </div>
                        </div>
                ...
                {visible === 4 && <SubmitSpam setVisible={setVisible} type={type} submitReportToAdmin={submitReportToAdmin} loading={loading} />}
                {visible === 5 && <SubmitNaudity setVisible={setVisible} type={type} submitReportToAdmin={submitReportToAdmin} loading={loading} />}
                {visible === 6 && <SubmitSharingPrivate setVisible={setVisible} type={type} submitReportToAdmin={submitReportToAdmin} loading={loading} />}
                {visible === 7 && <SubmitViolence setVisible={setVisible} type={type} submitReportToAdmin={submitReportToAdmin} loading={loading} />}
                {visible === 8 && <SubmitAnimalAbuse setVisible={setVisible} type={type} submitReportToAdmin={submitReportToAdmin} loading={loading} />}
                {visible === 9 && <SubmitSexualViolence setVisible={setVisible} type={type} submitReportToAdmin={submitReportToAdmin} loading={loading} />}
                {visible === 10 && <SubmitCommunityStandards setVisible={setVisible} type={type} submitReportToAdmin={submitReportToAdmin} loading={loading} />}
            </div>
        </div>
    );
}
