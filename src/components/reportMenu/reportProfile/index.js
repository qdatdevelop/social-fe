...
export default function ReportMenu_Profile({ setReport_Profile, report_Profile }) {
    ...
    return (
        <div
            ...
            <div className="mmenu_report">
                ...
                {!visible && (
                    <div>
                        ...
                        <div
                            ...
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>Fake account</span>
                        ...
                        <div
                            ...
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>Fake name</span>
                            <div className="rArrow">
                                <i className="right_icon"></i>
                            </div>
                        </div>
                        <div
                            ...
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>Posting inappropriate things</span>
                            <div className="rArrow">
                                <i className="right_icon"></i>
                            </div>
                        </div>
                        <div
                            ...
                            <span style={{ fontSize: "18px", fontWeight: "500" }}>Something else</span>
                            <div className="rArrow">
                                <i className="right_icon"></i>
                            </div>
                        </div>
                ...
                {visible && <SubmitProfile setVisible={setVisible} type={type} submitReportToAdmin={submitReportToAdmin} loading={loading} />}
            </div>
        </div>
    );
}
