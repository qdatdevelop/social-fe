...
export default function SearchMessMenu({ color, setShowSearchMenu, token, listMess, openChatWindow, setShowMessMenu, onlineUsers }) {
    ...
    console.log(results);
    return (
        <div className="header_left search_area scrollbar" ref={menu} style={{ width: "332px" }}>
