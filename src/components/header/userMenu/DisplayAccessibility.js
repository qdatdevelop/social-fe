        ...
        <div className="absolute_wrap">
            ...
            <div className="mmenu_main">
                ...
                <div className="mmenu_col">
                    ...
                    <span className="mmenu_span2">Adjust the appearance of Zuino to reduce glare and give your eyes a break.</span>
                </div>
            </div>
            <label
                htmlFor="darkOff"
                ...
                <span>Off</span>
                {darkTheme ? <input type="radio" name="dark" id="darkOff" /> : <input type="radio" name="dark" id="darkOff" checked />}
            </label>
            <label
                htmlFor="darkOn"
                className="hover1"
